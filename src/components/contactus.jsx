...
//             <span class="text">{t("contactsectionV.send")}</span>
//             <span class="icon">
//             <svg viewBox="0 0 512.005 512.005" xmlns="http://www.w3.org/2000/svg">
...
//     e.preventDefault();
//     if (validate()) {
//       // 🔹 تشغيل الأنيميشن بعد التحقق من صحة البيانات
...
//     // 👇 ترجع من تحت بنفس الزاوية
//     .set(iconRef.current, {
//       x: -150,   // تبدأ من يسار تحت
//       y: 150,
//       rotation: 20,
//       opacity: 0
//     })
...
//     // 🛫 يطير لزاوية الشاشة (يمين فوق)
//     tl.to(iconRef.current, {
//       duration: 1,
//       x: screenWidth,   // أقصى اليمين
//       y: -screenHeight, // أقصى الأعلى
//       scale: 1.2,
//       rotation: -30,
//       ease: "power2.inOut",
//       opacity: 1,
...
const handleSubmit = (e) => {
  ...
  if (validate()) {
    ...
    icon.classList.add("fly"); // 🌀 أضف كلاس الذيل
    ...
    .to(icon, {
      ...
      ease: "power2.out",
      onComplete: () => {
        icon.classList.remove("fly"); // ✅ شل الكلاس بعد الرجوع
      }
    });
